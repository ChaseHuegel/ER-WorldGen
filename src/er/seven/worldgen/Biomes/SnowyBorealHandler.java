...
public class SnowyBorealHandler extends ChunkHandler
{
	private FastNoise dirtNoise;
	public SnowyBorealHandler()
	{
	...
	public void PopulateAt(Random random, int x, int z, DecorationArea area, World world)
	{
		...
		//	Foliage
		else if (blockAbove != Material.WATER && BlockUtil.isDirt(block) && dirtNoise.GetValue(x, z) > 0)
		{
