...
public class BadlandsPlateauHandler extends ChunkHandler
{	
	//	DECORATION
	...
	@Override
	public List<Biome> getValidBiomes() { return Arrays.asList( Biome.BADLANDS_PLATEAU, Biome.MODIFIED_BADLANDS_PLATEAU ); }
		...
		for (int y = 128; y > 8; y--) 
		{
			...
			if (y > 16 || random.nextInt(y) > 8)
			{
				...
				case TERRACOTTA:
					...
					{
						replacementMaterial = Material.RED_SAND;
					}
					break;
				case DIRT:
					if (BlockUtil.isExposed(area, x, y, z))
